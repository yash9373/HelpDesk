            ...
            <form method="POST" action="{{ route('tickets.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-4 relative">
                    ...
                    <input id="subject" name="subject"
                        ...
                        autocomplete="off" placeholder="e.g. Unable to access email" />
                    <p class="text-xs text-gray-400 mt-1">Start typing the subject — suggestions will appear as you
                        type.</p>
                    <div id="suggestions"
                        class="absolute left-0 right-0 mt-1 z-50 bg-white border rounded shadow max-h-60 overflow-auto hidden">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <button type="button" id="suggest-debug-toggle" class="bg-gray-100 hover:bg-gray-200 text-gray-800 px-2 py-2 rounded text-sm">Debug</button> -->
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Allowed: png, jpg, jpeg, pdf, txt, log. Max 5MB each.
                            </p>
                        </div>

                        <div class="mb-4">
                            <button type="submit"
                                class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded border border-gray-300 shadow-sm"
                                style="background-color:#16a34a;color:#fff;padding:8px 14px;border-radius:6px;border:1px solid #15803d;box-shadow:0 1px 2px rgba(0,0,0,0.06);">Create
                                Ticket</button>
                        </div>
                    </div>
                </div>
            ...
            (function () {
                ...
                function render(items) {
                    ...
                    suggestionsDiv.innerHTML = items.map((i, idx) => {
                        ...
                        return `
                <div class="p-2 border-b suggestion-item cursor-pointer hover:bg-gray-50 flex justify-between" 
                     data-idx="${idx}" 
                     data-id="${i.ticket.id}" 
                ...
                function selectItem(el) {
                    ...
                    // Focus back on subject for better UX
                    subjectInput.focus();
                }
